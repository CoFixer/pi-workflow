...
- `.pi/react/guides/typescript-standards.md` - TypeScript error patterns and best practices
- `.pi/react/guides/best-practices.md` - React coding standards

### React & Components
- `.pi/react/guides/component-patterns.md` - React component issues and structure
- `.pi/react/guides/loading-and-error-states.md` - Async/loading issues

### Data & API
- `.pi/react/guides/data-fetching.md` - API/fetch errors
- `.pi/react/guides/tanstack-query.md` - TanStack Query errors and patterns

### Styling
- `.pi/react/guides/styling-guide.md` - CSS/Tailwind issues

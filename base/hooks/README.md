...
```bash
# Copy both files
cp skill-activation-prompt.sh your-project/.pi/hooks/
cp skill-activation-prompt.ts your-project/.pi/hooks/

# Make executable
chmod +x your-project/.pi/hooks/skill-activation-prompt.sh

# Install dependencies
cd your-project/.pi/hooks
npm install
```
...
```bash
# Copy file
cp post-tool-use-tracker.sh your-project/.pi/hooks/

# Make executable
chmod +x your-project/.pi/hooks/post-tool-use-tracker.sh
```
